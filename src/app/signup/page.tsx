...
export default function SignupPage() {
    ...
    return (
            <div className="flex flex-col items-center justify-center min-h-screen py-2">
                <h1 className="p-4">{!loading ? 'Sign Up' : 'Processing... Please wait'}</h1>
                <hr />
                ...
                >
                    {buttonDisabled ? "Already Signed Up" : "Sign Up"}
                </button>
                <Link className=" hover:uppercase" href='/login'>Already Signed Up</Link>
            </div>
        )
}